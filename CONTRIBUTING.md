# Contributing to bloomwell

Thank you for your interest in contributing to bloomwell! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/bloomwell.git
   cd bloomwell
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/bloomwell.git
   ```
...
By contributing to bloomwell, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
